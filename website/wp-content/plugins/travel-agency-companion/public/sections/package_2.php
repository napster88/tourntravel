...
$title       = get_theme_mod( 'deal_title_2', __( 'Deals and Discounts', 'travel-agency-companion' ) );
$content     = get_theme_mod( 'deal_desc_2', __( 'how the special deals and discounts to your customers here. You can customize this section from Appearance > Customize > Home Page Settings > Deals Section.', 'travel-agency-companion' ) );
$post_one    = get_theme_mod( 'deal_post_one_2' );
$post_two    = get_theme_mod( 'deal_post_two_2' );
$post_three  = get_theme_mod( 'deal_post_three_2' );
$label       = get_theme_mod( 'deal_readmore_2', __( 'Book Now', 'travel-agency-companion' ) );
$view_all    = get_theme_mod( 'deal_view_all_label_2', __( 'View All Deals', 'travel-agency-companion' ) );
$view_url    = get_theme_mod( 'deal_view_all_url_2', '#' );
...
<section class="our-deals" id="deal_section">
	<div class="container">
        ...
        <header class="section-header wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
			<?php 
                if( $title ) echo '<h2 class="section-title">' . esc_html( travel_agency_companion_get_deal_title('2') ) . '</h2>';
                if( $content ) echo '<div class="section-content">' . wp_kses_post( travel_agency_companion_get_deal_content('2') ) . '</div>'; 
            ?>
		</header>
        <?php } ?>
