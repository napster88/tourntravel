...
$title       = get_theme_mod( 'deal_title_1', __( 'Package', 'travel-agency-companion' ) );
$content     = get_theme_mod( 'deal_desc_1', __( 'how the special deals and discounts to your customers here. You can customize this section from Appearance > Customize > Home Page Settings > Deals Section.', 'travel-agency-companion' ) );
$post_one    = get_theme_mod( 'deal_post_one_1' );
$post_two    = get_theme_mod( 'deal_post_two_1' );
$post_three  = get_theme_mod( 'deal_post_three_1' );
$label       = get_theme_mod( 'deal_readmore_1', __( 'Book Now', 'travel-agency-companion' ) );
$view_all    = get_theme_mod( 'deal_view_all_label_1', __( 'View All Deals', 'travel-agency-companion' ) );
$view_url    = get_theme_mod( 'deal_view_all_url_1', '#' );
...
<section class="our-deals" id="deal_section">
	<div class="container">
        ...
        <header class="section-header wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
			<?php 
                if( $title ) echo '<h2 class="section-title">' . esc_html( travel_agency_companion_get_deal_title('1') ) . '</h2>';
                if( $content ) echo '<div class="section-content">' . wp_kses_post( travel_agency_companion_get_deal_content('1') ) . '</div>'; 
            ?>
		</header>
        <?php } ?>
