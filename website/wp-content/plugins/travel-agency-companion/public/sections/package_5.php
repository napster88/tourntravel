...
$title       = get_theme_mod( 'deal_title_5', __( 'Deals and Discounts', 'travel-agency-companion' ) );
$content     = get_theme_mod( 'deal_desc_5', __( 'how the special deals and discounts to your customers here. You can customize this section from Appearance > Customize > Home Page Settings > Deals Section.', 'travel-agency-companion' ) );
$post_one    = get_theme_mod( 'deal_post_one_5' );
$post_two    = get_theme_mod( 'deal_post_two_5' );
$post_three  = get_theme_mod( 'deal_post_three_5' );
$label       = get_theme_mod( 'deal_readmore_5', __( 'Book Now', 'travel-agency-companion' ) );
$view_all    = get_theme_mod( 'deal_view_all_label_5', __( 'View All Deals', 'travel-agency-companion' ) );
$view_url    = get_theme_mod( 'deal_view_all_url_5', '#' );
...
<section class="our-deals" id="deal_section">
	<div class="container">
        ...
        <header class="section-header wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
			<?php 
                if( $title ) echo '<h2 class="section-title">' . esc_html( travel_agency_companion_get_deal_title('5') ) . '</h2>';
                if( $content ) echo '<div class="section-content">' . wp_kses_post( travel_agency_companion_get_deal_content('5') ) . '</div>'; 
            ?>
		</header>
        <?php } ?>
