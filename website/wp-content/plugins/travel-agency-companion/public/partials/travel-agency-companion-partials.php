...
*/
function travel_agency_companion_get_deal_title($id){
    return get_theme_mod( 'deal_title_'.$id, __( 'Deals and Discounts', 'travel-agency-companion' ) );
}

/**
 * Return deal section content
*/
function travel_agency_companion_get_deal_content($id){
    return wpautop( get_theme_mod( 'deal_desc_'.$id, __( 'how the special deals and discounts to your customers here. You can customize this section from Appearance > Customize > Home Page Settings > Deals Section.', 'travel-agency-companion' ) ) );
}
