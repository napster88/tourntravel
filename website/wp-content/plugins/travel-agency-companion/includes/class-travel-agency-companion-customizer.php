...
function travel_agency_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'featured_section', array(
        'title'    => __( 'Add Package Section', 'travel-agency-companion' ),
        'priority' => 35,
        'panel'    => 'home_page_setting',
    ) );
    ...
    if( $obj->travel_agency_is_wpte_activated() ){
        ...
        $wp_customize->add_control(
            'featured_cat',
            array(
                'label'       => __( 'Choose Featured Package Category', 'travel-agency-companion' ),
                'description' => __( 'Go to Trips > Activities and add. Then you will be able to select a trip activities from the dropdown.', 'travel-agency-companion' ),
                'section'     => 'featured_section',
                'type'        => 'select',
        ...
        $wp_customize->add_control(
            'no_of_trips',
            array(
                'label' => __( 'No. of Packages', 'travel-agency-companion' ),
                'section' => 'featured_section',
                'type' => 'select',
                'choices' => array(
					...
					/* '9' => __( '6', 'travel-agency-companion' ),
					'12' => __( '6', 'travel-agency-companion' ),
					'15' => __( '6', 'travel-agency-companion' ), */
                )
            )
        );

        $number_of_trips = get_theme_mod( 'no_of_trips', 15 );
        for( $i=1; $i<=$number_of_trips; $i++ ){
            ...
            $wp_customize->add_control(
                'choose_trip_'. $i,
                array(
                    'label'       => sprintf( __( 'Latest Package #%1$s', 'travel-agency-companion' ), $i ),
                    'section'     => 'featured_section',
                    'type'        => 'select',
                    'choices'     => $obj->travel_agency_get_posts( 'trip' ),
                    'active_callback' => 'travel_agency_companion_trip_ac',
        ...
        $wp_customize->add_setting(
            'featured_view_all',
            array(
                'default'           => __( 'View All Package', 'travel-agency-companion' ),
                'sanitize_callback' => 'sanitize_text_field',
                'transport'         => 'postMessage'
            )
        );
    ...
    $wp_customize->add_control(
		...
		/* New section more */
		 ...
		 /** Deals Section */
    $wp_customize->add_section( 'deal_section_'.$i, array(
        'title'    => __( 'Add Package Section '.$i, 'travel-agency-companion' ),
        'priority' => 45,
        'panel'    => 'home_page_setting',
    ) ); 
    ...
    $wp_customize->add_control(
		'ed_deal_section_'.$i,
		array(
			'section' => 'deal_section_'.$i,
			'label'	  => __( 'Enable Package Section', 'travel-agency-companion' ),
            'type'    => 'checkbox'
		)		
	);
	...
	$wp_customize->add_setting(
        'deal_title_'.$i,
        array(
            'default'           => __( 'Package', 'travel-agency-companion' ),
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage'
        )
    );
   ...
   // if( $obj->travel_agency_is_wpte_activated() ){
      ...
      /*   $wp_customize->add_setting(
         ...
         */
        /** Deal Trip Note */
    	$wp_customize->add_setting( 'deal_tripnote_'.$i,
            array(
                'default' => '',
                'sanitize_callback' => 'wp_kses_post',
            )
        ...
        $wp_customize->selective_refresh->add_partial( 'deal_readmore_'.$i, array(
        ...
        $wp_customize->selective_refresh->add_partial( 'deal_view_all_label_'.$i, array(
