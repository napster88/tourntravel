...
class Wp_Travel_Engine_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'select2', plugin_dir_url( __FILE__ ) . 'js/select2.js', array( 'jquery'), '5.6.3', true );
	}
			...
			switch ( $column ) {
				...
				case 'cost':
				    ...
				    echo esc_attr($currency).' ';
				 	...
				 	if( isset( $terms['place_order']['cost'] ) ){
						echo intval( $terms['place_order']['cost'] ) + intval( $terms['place_order']['due'] );
					} 
				break;
				...
				case 'paid':
				 	...
				 	if( isset( $terms['place_order']['due'] ) && $terms['place_order']['due']!='' ){
					    ...
					    $currency = $obj->wp_travel_engine_currencies_symbol( $code );
					    echo esc_attr($currency).' ';
						echo intval( $terms['place_order']['cost'] ) + intval( $terms['place_order']['due'] ) - intval( $terms['place_order']['due'] );
					}
					else{
						$code = 'USD';
					    if( isset( $wp_travel_engine_setting_option_setting['currency_code'] ) && $wp_travel_engine_setting_option_setting['currency_code']!= '' )
  ...
  function wp_travel_engine_create_package_taxonomies() {
		// Add new taxonomy, make it hierarchical (like destination)
		$labels = array(
			'name'              => _x( 'Packages', 'taxonomy general name', 'wp-travel-engine' ),
			'singular_name'     => _x( 'Packages', 'taxonomy singular name', 'wp-travel-engine' ),
			'search_items'      => __( 'Search Packages', 'wp-travel-engine' ),
			'all_items'         => __( 'All Packages', 'wp-travel-engine' ),
			'parent_item'       => __( 'Parent Packages', 'wp-travel-engine' ),
			'parent_item_colon' => __( 'Parent Packages', 'wp-travel-engine' ),
			'edit_item'         => __( 'Edit Packages', 'wp-travel-engine' ),
			'update_item'       => __( 'Update Packages', 'wp-travel-engine' ),
			'add_new_item'      => __( 'Add New Packages', 'wp-travel-engine' ),
			'new_item_name'     => __( 'New Packages Name', 'wp-travel-engine' ),
			'menu_name'         => __( 'Packages', 'wp-travel-engine' ),
		);
		...
		register_taxonomy( 'packages', array( 'trip' ), $args );
	}
  function wp_travel_engine_create_adventure_taxonomies() {
		// Add new taxonomy, make it hierarchical (like destination)
		$labels = array(
			'name'              => _x( 'Adventure', 'taxonomy general name', 'wp-travel-engine' ),
			'singular_name'     => _x( 'Adventure', 'taxonomy singular name', 'wp-travel-engine' ),
			'search_items'      => __( 'Search Adventure', 'wp-travel-engine' ),
			'all_items'         => __( 'All Adventure', 'wp-travel-engine' ),
			'parent_item'       => __( 'Parent Adventure', 'wp-travel-engine' ),
			'parent_item_colon' => __( 'Parent Adventure', 'wp-travel-engine' ),
			'edit_item'         => __( 'Edit Adventure', 'wp-travel-engine' ),
			'update_item'       => __( 'Update Adventure', 'wp-travel-engine' ),
			'add_new_item'      => __( 'Add New Adventure', 'wp-travel-engine' ),
			'new_item_name'     => __( 'New Adventure Name', 'wp-travel-engine' ),
			'menu_name'         => __( 'Adventure', 'wp-travel-engine' ),
		);
		...
		$args = array(
			...
			'show_ui'           => true,
			'show_admin_column' => true,
			'rewrite'           => array( 'slug' => 'adventures','hierarchical' => true ),
		);

		register_taxonomy( 'adventures', array( 'trip' ), $args );
	}
	/**
	...
	function wp_travel_engine_create_car_rental_taxonomies() {
		$labels = array(
			'name'              => _x( 'Car Rental', 'taxonomy general name', 'wp-travel-engine' ),
			'singular_name'     => _x( 'Car Rental', 'taxonomy singular name', 'wp-travel-engine' ),
			'search_items'      => __( 'Search Car Rental', 'wp-travel-engine' ),
			'all_items'         => __( 'All Car Rental', 'wp-travel-engine' ),
			'parent_item'       => __( 'Parent Car Rental', 'wp-travel-engine' ),
			'parent_item_colon' => __( 'Parent Car Rental', 'wp-travel-engine' ),
			'edit_item'         => __( 'Edit Car Rental', 'wp-travel-engine' ),
			'update_item'       => __( 'Update Car Rental', 'wp-travel-engine' ),
			'add_new_item'      => __( 'Add New Car Rental', 'wp-travel-engine' ),
			'new_item_name'     => __( 'New Car Rental Name', 'wp-travel-engine' ),
			'menu_name'         => __( 'Car Rental', 'wp-travel-engine' ),
		);
		...
		$args = array(
			...
			'show_ui'           => true,
			'show_admin_column' => true,
			'rewrite'           => array( 'slug' => 'car-rental','hierarchical' => true ),
		);

		register_taxonomy( 'car-rental', array( 'trip' ), $args );
