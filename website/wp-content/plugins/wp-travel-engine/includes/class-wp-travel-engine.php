...
class Wp_Travel_Engine {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin, 'wp_travel_engine_create_car_rental_taxonomies' );
		$this->loader->add_action( 'init', $plugin_admin, 'wp_travel_engine_create_adventure_taxonomies' );
		$this->loader->add_action( 'init', $plugin_admin, 'wp_travel_engine_create_package_taxonomies' );
