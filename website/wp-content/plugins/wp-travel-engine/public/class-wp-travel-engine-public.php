...
class Wp_Travel_Engine_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name.'custom', plugin_dir_url( __FILE__ ) . 'js/custom.js', array( 'jquery','jquery-ui-core' ), $this->version, false );
		...
		wp_localize_script( $this->plugin_name, 'WPTE_Price_Separator', $thousands_separator );
		...
		wp_enqueue_script( 'owl-carousel', plugin_dir_url( __FILE__ ) . 'js/owl.carousel.js', array( 'jquery' ), '2.3.4', false );
                ...
                <div class="holder">
                    ...
                    <div class="text-holder">
                        ...
                        if( class_exists('WTE_Fixed_Starting_Dates') ){ 
                            ...
                            if( isset( $starting_dates['departure_dates'] ) && ! empty( $starting_dates['departure_dates'] ) && isset($starting_dates['departure_dates']['sdate']) ){ ?>
                                <div class="next-trip-info">
                                    <?php echo '<div class="fsd-title">'.esc_html__( 'Next Departure', 'wp-travel-engine'
                                     ).'</div>'; ?>
                                    <ul class="next-departure-list">
                                        <?php
                                        global $post;
